...
```{r}
mdd<-fread("C:/Users/HP OMEN GAMING/Desktop/mr-uganda-hackathon-Final/scratch/FE_eas_exclu_whi_jhs_23andMe_qced_rsid.txt.gz")
head(mdd)
```
...
dat <- dat %>%
  ...
  slice_head(n=1)
dim(dat)
write.csv(dat, "C:/Users/HP OMEN GAMING/Desktop/mr-uganda-hackathon-Final/results/EAS_druggable_SNP.csv", row.names = FALSE)
...
```{r}
res <- mr(dat)
save(res, file=file.path("C:/Users/HP OMEN GAMING/Desktop/mr-uganda-hackathon-Final/results", "eas_druggable.rdata"))
